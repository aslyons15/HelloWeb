...
DREAMS = ['Python. Python, everywhere.', 'Hackathon']

#the @app sign is a decorator
#decorator is the way to attach a function to a objects
@app.after_request
...
def dreams():
    ...
    #making a request to the server and sends to the browser
